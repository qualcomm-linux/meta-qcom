...
do_install() {
    ...
    install -d ${D}${datadir}/qcom/qcs8300/Qualcomm/IQ8275-EVK/dsp/cdsp
    install -d ${D}${datadir}/qcom/qcs8300/Qualcomm/QCS8300-RIDE/dsp/cdsp
    install -d ${D}${datadir}/qcom/sa8775p/Qualcomm/IQ9075-EVK/dsp/cdsp
    ...
    install -m 0644 ${S}/usr/lib/dsp/cdsp/cv/v75/MONACO/*.so ${D}${datadir}/qcom/qcs8300/Qualcomm/IQ8275-EVK/dsp/cdsp
    install -m 0644 ${S}/usr/lib/dsp/cdsp/cv/v75/MONACO/*.so ${D}${datadir}/qcom/qcs8300/Qualcomm/QCS8300-RIDE/dsp/cdsp
    install -m 0644 ${S}/usr/lib/dsp/cdsp/cv/v73/LEMANS/*.so ${D}${datadir}/qcom/sa8775p/Qualcomm/IQ9075-EVK/dsp/cdsp
...
"
INSANE_SKIP:${PN}-iq9075-evk-dsp = "arch libdir"
INSANE_SKIP:${PN}-iq8275-evk-dsp = "arch libdir"
...
FILES:${PN}-iq9075-evk-dsp += "${datadir}/qcom/sa8775p/Qualcomm/IQ9075-EVK/dsp"
FILES:${PN}-iq8275-evk-dsp += "${datadir}/qcom/qcs8300/Qualcomm/IQ8275-EVK/dsp"
