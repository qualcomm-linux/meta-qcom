...
RDEPENDS:${PN}-qcom-db820c-adsp = "linux-firmware-qcom-apq8096-audio"
RDEPENDS:${PN}-qcom-iq8275-evk-adsp = "linux-firmware-qcom-qcs8300-audio"
RDEPENDS:${PN}-qcom-iq8275-evk-cdsp = "linux-firmware-qcom-qcs8300-compute"
RDEPENDS:${PN}-qcom-iq8275-evk-gdsp = "linux-firmware-qcom-qcs8300-generalpurpose"
RDEPENDS:${PN}-qcom-iq9075-evk-adsp = "linux-firmware-qcom-sa8775p-audio"
RDEPENDS:${PN}-qcom-iq9075-evk-cdsp = "linux-firmware-qcom-sa8775p-compute"
RDEPENDS:${PN}-qcom-iq9075-evk-gdsp = "linux-firmware-qcom-sa8775p-generalpurpose"
RDEPENDS:${PN}-qcom-qcs615-ride-adsp = "linux-firmware-qcom-qcs615-audio"
RDEPENDS:${PN}-qcom-qcs615-ride-cdsp = "linux-firmware-qcom-qcs615-compute"
RDEPENDS:${PN}-qcom-qcs8300-ride-adsp = "linux-firmware-qcom-qcs8300-audio"
RDEPENDS:${PN}-qcom-qcs8300-ride-cdsp = "linux-firmware-qcom-qcs8300-compute"
RDEPENDS:${PN}-qcom-qcs8300-ride-gdsp = "linux-firmware-qcom-qcs8300-generalpurpose"
RDEPENDS:${PN}-qcom-sa8775p-ride-adsp = "linux-firmware-qcom-sa8775p-audio"
RDEPENDS:${PN}-qcom-sa8775p-ride-cdsp = "linux-firmware-qcom-sa8775p-compute"
RDEPENDS:${PN}-qcom-sa8775p-ride-gdsp = "linux-firmware-qcom-sa8775p-generalpurpose"
RDEPENDS:${PN}-thundercomm-db845c-adsp = "linux-firmware-qcom-sdm845-audio"
RDEPENDS:${PN}-thundercomm-db845c-cdsp = "linux-firmware-qcom-sdm845-compute"
RDEPENDS:${PN}-thundercomm-db845c-sdsp = "linux-firmware-qcom-sdm845-thundercomm-db845c-sensors"
RDEPENDS:${PN}-thundercomm-rb1-adsp = "linux-firmware-qcom-qcm2290-audio"
RDEPENDS:${PN}-thundercomm-rb2-adsp = "linux-firmware-qcom-qrb4210-audio"
RDEPENDS:${PN}-thundercomm-rb2-cdsp = "linux-firmware-qcom-qrb4210-compute"
RDEPENDS:${PN}-thundercomm-rb3gen2-adsp = "linux-firmware-qcom-qcm6490-audio"
RDEPENDS:${PN}-thundercomm-rb3gen2-cdsp = "linux-firmware-qcom-qcm6490-compute"
RDEPENDS:${PN}-thundercomm-rb5-adsp = "linux-firmware-qcom-sm8250-audio"
RDEPENDS:${PN}-thundercomm-rb5-cdsp = "linux-firmware-qcom-sm8250-compute"
RDEPENDS:${PN}-thundercomm-rb5-sdsp = "linux-firmware-qcom-sm8250-thundercomm-rb5-sensors"
