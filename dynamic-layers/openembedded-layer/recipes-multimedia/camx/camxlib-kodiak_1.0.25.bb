...
do_install:append() {
    ...
    ln -sr ${D}${datadir}/libcamx_hardware_kodiak.so.1 ${D}${datadir}/libcamera_hardware_kodiak.so.0
    ln -sr ${D}${datadir}/libcamx_metadata_kodiak.so.1 ${D}${datadir}/libcamera_metadata_kodiak.so.0
}
