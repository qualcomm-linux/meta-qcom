...
SRC_URI[sha256sum] = "29d3f6c0b38b95696d5a0aca55b7b4921e8e9d1c82abd303ea73e6b5e7a18f5b"
...
do_install() {
    ...
    install -d ${D}${sysconfdir}/sensors/registry/registry
